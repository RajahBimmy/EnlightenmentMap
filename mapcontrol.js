...
$(document).ready(function(){
  ...
  var crusoe = [
      {latLng: [53.9583, -1.0803], name: 'York', style: {fill: '#F8E23B'},
        info: "<h1>York, 1632</h1><h4>Crusoe is born and raised.</h4><p><i></i></p>"},
      
      {latLng: [51.5072, -0.1275], name: 'London', style: {fill: '#F8E23B'},
        info: "<h1>London, 1651</h1><h4>Crusoe disobeys his father and sets sail on the open seas.</h4><p></p>"},
      
      {latLng: [34.0333, -6.8000], name: 'Sallee', style: {fill: '#F8E23B'},
        info: "<h1>Sallee, 1653</h1><h4>Crusoe is made a slave, but escapes shortly thereafter.</h4><p></p>"},
      
      {latLng: [-15.7833, -47.8667], name: 'Brazil', style: {fill: '#F8E23B', r:10, opacity:0.75},
        info: "<h1>Brazil, 1656-1659</h1><h4>Crusoe founds a plantation in the New World.</h4><p></p>"},
      ...
      {latLng: [13.16, -61.23], name: "Nearby Island Under Spanish Regime", style: {fill: '#F8E23B'},
        info: "<h1>Nearby Island, 1661</h1><h4>After two years, Crusoe explores his realm and discovers a distant Spanish isle.</h4><p></p>"},
      
      {latLng: [38.7139, -9.1394], name: 'Lisbon', style: {fill: '#F8E23B'},
        info: "<h1>Lisbon, 1687</h1><h4>Returning to Europe from his long journey, Crusoe is updated on his financial status by the Portugese Captain.</h4><p></p>"},
      
      {latLng: [42.8167, -1.6500], name: 'Pampeluna', style: {fill: '#F8E23B'},
        info: "<h1>Pampeluna, 1687</h1><h4>Crusoe stops in modern Pampelona with Friday.</h4><p></p>"},
      
      {latLng: [43.6045, 1.4440], name: 'Toulouse', style: {fill: '#F8E23B'},
        info: "<h1>Toulouse, 1687</h1><h4>Crusoe's entourage is attacked by wolves. Friday manages to hold them off.</h4><p></p>"},
      
      {latLng: [51.1295, 1.1089], name: 'Dover', style: {fill: '#F8E23B'},
        info: "<h1>Dover, England</h1><h4>Crusoe marries and settles into a new home by the sea, but only remains a short while before returning to his island.</h4><p><i>\"When I came to England I was as perfect a stranger to all the world as if I had never been known there.\"</i><br>(Defoe, ??)</p>"}
    ];
